            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a onclick="return confirm('Ganti Status kandidat menjadi sortir?')" href="<?= base_url('kandidat/status_sortir/') . $kandidati['id'] ?>" class="btn btn btn-sm btn-secondary">Sortir<i class="fa fa-fw fa-filter"></i></a>
